...
*Last Updated **2025-08-14 04:34:06**.*
...
| :-- | --: | --: | --: | --: | --: | --: | --: | --: |
| [2020s](https://github.com/nuuuwan/lk_legal_docs_data/tree/data_2020s/data) | 100% | 18,078 | 51,622 | 21.1 GB | 14,136 | 3,927 | 15 | 0 |
...
| **Total** | **100%** | **44,287** | **124,089** | **45.5 GB** | **38,383** | **5,361** | **543** | **0** |
